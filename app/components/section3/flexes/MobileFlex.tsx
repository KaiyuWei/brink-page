    ...
    <div className="px-14 flex-container flex-row content-between">
      ...
      <div className={`${styles.flexText}`}>
        <p className="plain-text">
          ...
          turpis. Sed quis erat arcu. Phasellus gravida felis quis ex mattis,
          sed suscipit tellus tincidunt. In imperdiet dapibus vehicula. In
          auctor nec nibh vestibulum ornare. Morbi porta, enim hendrerit
          consectetur ultrices, libero dui ultricies libero, vel rutrum sem
          magna quis augue. Nulla quis magna at lorem sodales gravida.
        </p>
      </div>
